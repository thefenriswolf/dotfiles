...
binde =, XF86MonBrightnessUp, exec, brightnessctl --device=amdgpu_bl0 set +5% && notify-send --urgency=low --expire-time=150 "Brightness: UP"

binde =, XF86MonBrightnessDown, exec, brightnessctl --device=amdgpu_bl0 set 5%- && notify-send --urgency=low --expire-time=150 "Brightness: DOWN"
