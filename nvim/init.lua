...
vim.defer_fn(function()
    ...
    -- require("plugins")
    --
    -- Re-enable syntax highlighting and filetype plugin once Neovim is fully loaded
    vim.cmd([[
    syntax on
    filetype on
...
-- settings are stored in "lua/custom/settings/init.lua"
...
require("lazy").setup({
    ...
    { -- Fuzzy Finder (files, lsp, etc)
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>sn", function()
                builtin.find_files({
                    cwd = vim.fn.stdpath("playground/dotfiles/nvim/")
                })
    ...
    }, -- LSP Plugins
    {
        ...
        config = function()
            ...
            ----------------
            -- LSP SERVER SETUP
            -- config is stored at "lua/custom/lspservers/init.lua"
