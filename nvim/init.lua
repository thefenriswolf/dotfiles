...
require("lazy").setup({
    ...
    --			languagetool_cmd = "/etc/profiles/per-user/ro/bin/languagetool",
    --			langtool_parameters = "",
    --		}),
    --	},
    {
    ...
    }, -- LSP Plugins
    {
        ...
        config = function()
            ...
            local servers = {
                ltex = { -- grammar checking LSP
                    cmd = {
                        "/etc/profiles/per-user/ro/bin/ltex-ls", "--no-endless"
                    },
